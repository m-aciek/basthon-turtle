...
```text
http://localhost:8000/examples/pyodide/?package=../../dist/basthon_turtle-0.4.0-py3-none-any.whl
```
...
```text
?package=../../dist/basthon_turtle-0.4.0-py3-none-any.whl&pyodide=/pyodide/pyodide.mjs
```
